import{_ as o,M as p,p as c,q as r,R as n,t as s,N as e,a1 as t}from"./framework-d81ad7e5.js";const l={},i=n("h1",{id:"eslint-格式化",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#eslint-格式化","aria-hidden":"true"},"#"),s(" ESLint 格式化")],-1),u={href:"https://eslint.org/",target:"_blank",rel:"noopener noreferrer"},d=t(`<h2 id="eslint-依赖" tabindex="-1"><a class="header-anchor" href="#eslint-依赖" aria-hidden="true">#</a> ESLint 依赖</h2><p>安装依赖：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 初始化</span>
