import{_ as n,p as s,q as a,a1 as p}from"./framework-d81ad7e5.js";const t={},o=p(`<h2 id="echarts属性配置" tabindex="-1"><a class="header-anchor" href="#echarts属性配置" aria-hidden="true">#</a> echarts属性配置</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 全图默认背景 </span>
...
<span class="token literal-property property">animationEasing</span><span class="token operator">:</span> <span class="token string">&#39;ExponentialOut&#39;</span>   
</code></pre></div>`,2),e=[o];function r(l,c){return s(),a("div",null,e)}const i=n(t,[["render",r],["__file","echarts_d.html.vue"]]);export{i as default};
