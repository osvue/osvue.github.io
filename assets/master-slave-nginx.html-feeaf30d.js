import{_ as e,M as t,p,q as c,R as o,t as n,N as l,V as r,a1 as a}from"./framework-d81ad7e5.js";const i={},k=a('<h2 id="准备" tabindex="-1"><a class="header-anchor" href="#准备" aria-hidden="true">#</a> 准备</h2><table><thead><tr><th>name</th><th>ip</th><th>role</th></tr></thead><tbody><tr><td>web01</td><td>10.0.0.133</td><td>MASTER</td></tr><tr><td>web02</td><td>10.0.0.134</td><td>BACKUP</td></tr></tbody></table>',2),u=a(`<p>修改 Nginx 的主页便于之后识别：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /usr/local/nginx/html/index.html
...
<span class="token comment"># &lt;h1&gt;Welcome to nginx2!&lt;/h1&gt;</span>
</code></pre></div>`,18);function d(m,h){const s=t("RouterLink");return p(),c("div",null,[k,o("p",null,[n("为虚拟机"),l(s,{to:"/backend/nginx/install-nginx.html#%E7%BC%96%E8%AF%91%E5%AE%89%E8%A3%85"},{default:r(()=>[n("安装")]),_:1}),n("好 Nginx 和 keepalived。")]),u])}const b=e(i,[["render",d],["__file","master-slave-nginx.html.vue"]]);export{b as default};
