...
<span class="token punctuation">}</span>
</code></pre></div></li><li><p>使用T extends MyInter表示泛型T必须是MyInter的子类，不一定非要使用接口类和抽象类同样适用。</p></li></ul></li></ul></li></ul>`,16),e=[o];function c(l,u){return s(),a("div",null,e)}const k=n(t,[["render",c],["__file","object.html.vue"]]);export{k as default};
